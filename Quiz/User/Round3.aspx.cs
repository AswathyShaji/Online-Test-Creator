...
public partial class User_Default3 : System.Web.UI.Page
{
    ...
    {
        string sel = "select * from tbl_question where section_id='3'";
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            Image1.ImageUrl = "~/Admin/images/" + dt.Rows[0]["image"].ToString();
    ...
    protected void RadioButtonList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            string ins = "insert into tbl_marks(user_id,marks_obtained,section_id) values('" + Session["userid"] + "','10','3')";
        ...
        {
            string ins = "insert into tbl_marks(user_id,marks_obtained,section_id) values('" + Session["userid"] + "','0','3')";
            obj.ExceuteCommand(ins);
            string sel1 = "select * from tbl_result where user_id='" + Session["userid"] + "'";
            DataTable dt1 = obj.GetDataTable(sel1);
            if (dt1.Rows.Count > 0)
