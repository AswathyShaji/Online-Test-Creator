<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="Admin_ChangePassword.aspx.cs" Inherits="Administrator_Default" %>
    ...
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td class="auto-style5">
                <asp:TextBox ID="txtcpwd" runat="server" BorderWidth="1px" OnTextChanged="txtcpwd_TextChanged" TextMode="Password" Width="155px" EnableTheming="True"></asp:TextBox>
            </td>
            <td>
        ...
        <tr>
            <td class="auto-style2">&nbsp;</td>
            <td class="auto-style5">
                <asp:Button ID="btnupdate" runat="server" BorderWidth="1px" OnClick="btnupdate_Click" Text="Change" ValidationGroup="vgroup" />
